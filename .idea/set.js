...
function cardMaker(amount){
    let newCards = [];
    for (let i = 0; i < amount; i++) {
        let card = deck.pop();
        newCards[i] = createCard(card)
    }
    return newCards;
}

//this creates a card in the ui
/*
where we have the main div with a id="card-12" class= "card".
and inside we have sub divs between 1 gto 3 divs with 3 class names
 */
...
function setFound() {
    ...
    //we want to replace the 3 cards with new ones
